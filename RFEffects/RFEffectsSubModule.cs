...
using RealmsForgotten.RFEffects.Feats;
	...
	public class RFEffectsSubModule : MBSubModuleBase
	{
		...
		protected override void OnGameStart(Game game, IGameStarter gameStarterObject)
		{
            ...
            if (game.GameType is Campaign)
			{
                ...
                gameStarterObject.AddModel(new TlachAndElveanMoraleModel());
                gameStarterObject.AddModel(new AthasBuildingConstructionModel());
                gameStarterObject.AddModel(new XilanRaidModel());
                gameStarterObject.AddModel(new XilanPartySpeedCalculatingModel());
                gameStarterObject.AddModel(new UndeadAndAqarunPrisonerRecruitmentCalculationModel());
                gameStarterObject.AddModel(new ElveanDefaultCharacterDevelopmentModel());
		...
		public override void OnMissionBehaviorInitialize(Mission mission)
		{
            ...
            mission.AddMissionBehavior(new FireSwordLogic());
        }
