...
namespace RealmsForgotten.UI.FloatingText
{
    public class FloatingTextManager
    {
        ...
        public int AddText(Func<string> text, Func<Vec3> positionProvider, Color color)
        {
    ...
    public record FloatingTextEntry(int Id, Func<string> Text, Func<Vec3> PositionProvider, Color Color) { }
}
