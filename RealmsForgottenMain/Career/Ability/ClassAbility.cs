...
namespace RealmsForgotten.Career.Ability
{
    public class ClassAbility
    {
        ...
        public static void RegisterAll()
        {
            ...
            All.Add(new ClassAbility("lightwarden_ability", "{=rf_lightwarden_ability_name}Radiant Benediction", "radiant_benediction_perk_a", "radiant_benediction_perk_b", "{=rf_career_radiant_benediction_desc} When is activated, heals all of your troops by 30% in a range of 5 meters.", "{=rf_career_radiant_benediction_desc} When is activated, heals all of your troops by 50% in a range of 10 meters.", lightwardenAbilityData));
        }
