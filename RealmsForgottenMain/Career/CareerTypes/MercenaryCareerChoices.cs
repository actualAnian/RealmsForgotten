...
#pragma warning restore CS8618 // Non-nullable field must contain a non-null value when exiting constructor. Consider adding the 'required' modifier or declaring as nullable.
        ...
        protected override void InitializePassives()
        {
            ...
            //tier 2
            _warlord_of_coin_1_passive1.Initialize(CareerID, "{=rf_career_troop_ranged_attack_15}Increases ranged damage of your troops by 15%", "WarlordOfCoin1", new CareerChoiceObject.PassiveEffect(15, PassiveEffectType.Ammo));
            ...
            _warlord_of_coin_1_passive3.Initialize(CareerID, "{=rf_career_spotting_MoFo_20}+20% spotting range in mountains and forests", "WarlordOfCoin1", new CareerChoiceObject.PassiveEffect(0.2f, PassiveEffectType.SpottingRange,
                (characterObject) => {
            ...
            _warlord_of_coin_2_passive3.Initialize(CareerID, "{=rf_career_spotting_DeSt}+20% spotting range in deserts and steppes", "WarlordOfCoin2", new CareerChoiceObject.PassiveEffect(0.2f, PassiveEffectType.SpottingRange,
                (characterObject) => {
                    if (characterObject.HeroObject != Hero.MainHero) return false;
                    var party = characterObject.HeroObject.PartyBelongedTo;
                    TerrainType faceTerrainType = Campaign.Current.MapSceneWrapper.GetFaceTerrainType(party.CurrentNavigationFace);
            ...
            //tier 3
            _mercenary_lord_1_passive1.Initialize(CareerID, "{=rf_career_party_speed_FoMoSw_20}+20% party movement speed in forest, mountain and swamp terrain", "MercenaryLord1", new CareerChoiceObject.PassiveEffect(0.2f, PassiveEffectType.PartyMovementSpeed,
            (characterObject) => {
                if (characterObject.HeroObject != Hero.MainHero) return false;
                var party = characterObject.HeroObject.PartyBelongedTo;
                TerrainType faceTerrainType = Campaign.Current.MapSceneWrapper.GetFaceTerrainType(party.CurrentNavigationFace);
            ...
            _mercenary_lord_2_passive1.Initialize(CareerID, "{=rf_career_party_speed_SnSt_10}+10% party movement speed in snow, and steppe terrain", "MercenaryLord2", new CareerChoiceObject.PassiveEffect(0.1f, PassiveEffectType.PartyMovementSpeed,
            (characterObject) => {
                if (characterObject.HeroObject != Hero.MainHero) return false;
                var party = characterObject.HeroObject.PartyBelongedTo;
                TerrainType faceTerrainType = Campaign.Current.MapSceneWrapper.GetFaceTerrainType(party.CurrentNavigationFace);
