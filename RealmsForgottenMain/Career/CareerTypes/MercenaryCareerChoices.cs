...
#pragma warning restore CS8618 // Non-nullable field must contain a non-null value when exiting constructor. Consider adding the 'required' modifier or declaring as nullable.
        ...
        protected override void InitializePassives()
        {
            ...
            _warlord_of_coin_1_passive5.Initialize(CareerID, "{=}Gain a magical artifact.", "WarlordOfCoin1", new CareerChoiceObject.ActiveEffect(() => { MobileParty.MainParty.ItemRoster.Add(new ItemRosterElement(MBObjectManager.Instance.GetObject<ItemObject>("a"))); }));
            ...
            _warlord_of_coin_2_passive5.Initialize(CareerID, "{=}Gain a special armor set.", "WarlordOfCoin2", new CareerChoiceObject.ActiveEffect(() => { MobileParty.MainParty.ItemRoster.Add(new ItemRosterElement(MBObjectManager.Instance.GetObject<ItemObject>("a"))); }));
