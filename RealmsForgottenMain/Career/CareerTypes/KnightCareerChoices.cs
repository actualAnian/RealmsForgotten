...
#pragma warning restore CS8618 // Non-nullable field must contain a non-null value when exiting constructor. Consider adding the 'required' modifier or declaring as nullable.
        ...
        protected override void InitializePassives()
        {
            ...
            _field_marshall_2_passive3.Initialize(CareerID, "{=rf_career_40_hitpoints_companions}Increase your companions hitpoints by 40", "FieldMarshall2", new CareerChoiceObject.PassiveEffect(40, PassiveEffectType.CompanionHealth));
            ...
            _paragon_of_virtue_2_passive4.Initialize(CareerID, "{=rf_career_troop_melee_30_ranged}Your ranged units get 30% melee damage resistance,", "ParagonOfVirtue2", new CareerChoiceObject.PassiveEffect(PassiveEffectType.TroopResistance, new DamageProportionTuple(DamageType.PhysicalMelee, 30), (Agent attacker, Agent victim) => { return victim.BelongsToMainParty() && victim.Character != null && victim.Character.IsRanged; }));
