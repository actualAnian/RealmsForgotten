...
namespace RealmsForgotten.Career.CareerTypes
{
    public class LightwardenCareerChoice : RFCareerChoicesBase
    {
        ...
        protected override void InitializePassives()
        {
            ...
            _word_spreader_1_passive5.Initialize(CareerID, "{=rf_career_party_reduced_5}Party wages are reduced by 5%", "WordSpeader1", new CareerChoiceObject.PassiveEffect(-0.05f, PassiveEffectType.Special));
