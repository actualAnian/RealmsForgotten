...
namespace RealmsForgotten.Career.CareerTypes
{
    public class LightwardenCareerChoice : RFCareerChoicesBase
    {
        ...
        protected override void InitializePassives()
        {
            ...
            _word_spreader_1_passive5.Initialize(CareerID, "{=rf_career_party_reduced_5}Infantry troop wages are reduced by 5%", "WordSpeader1", new CareerChoiceObject.PassiveEffect(-0.05f, PassiveEffectType.Special));

            _word_spreader_2_passive1.Initialize(CareerID, "{=rf_career_recruitment_cost}Recruitment and upgrade cost of infantry troops 10% cheaper", "WordSpeader2", new CareerChoiceObject.PassiveEffect(-0.05f, PassiveEffectType.Special));
            ...
            _word_spreader_2_passive1.Initialize(CareerID, "{=rf_career_recruitment_cost}Recruitment and upgrade cost of infantry troops 15% cheaper", "BlessedOne2", new CareerChoiceObject.PassiveEffect(-0.05f, PassiveEffectType.Special));
