...
namespace RealmsForgotten
{
    public class RFCharacterCreationContent : SandboxCharacterCreationContent
    {
        ...
        public void AddCultureLocationMenu(CharacterCreation characterCreation)
        {
            ...
            characterCreationCategory.AddCategoryOption(new("{=CulturedStart50}Onin a caravan to the free state of Balik", null), new(), null, 0, 0, 0, null, new(this.BalikLocationOnConsequence), new(this.DoNothingOnApply), new("{=CulturedStart36}You leave the caravan right at the gates", null), null, 0, 0, 0, 0, 0);
