...
namespace RealmsForgotten.AiMade
 {
    ...
    internal class SlaveBehavior : CampaignBehaviorBase
    {
        ...
        private static readonly HashSet<string> AllowedSettlementIds = new()
        {
            "town_A1", // Replace these with actual settlement IDs
            "town_A2",
            "town_A3"
        };
        ...
        private void OnDailyTick()
        {
            ...
            {
                if (CampaignTime.Now >= keyValue.Value && AllowedSettlementIds.Contains(keyValue.Key.StringId))
                {
        ...
        {
            if (AllowedSettlementIds.Contains(settlement.StringId) && SlaveData.ContainsKey(settlement.StringId) &&
        ...
        private bool IsBuildSlaveryPossible =>
            Settlement.CurrentSettlement?.IsTown == true &&
            AllowedSettlementIds.Contains(Settlement.CurrentSettlement.StringId) &&
        ...
        private void SessionLaunched(CampaignGameStarter campaignGameStarter)
        {
            campaignGameStarter.AddGameMenuOption("town", "town_build_slave",
                ...
                {
                    if (!AllowedSettlementIds.Contains(Settlement.CurrentSettlement.StringId))
                        return false;
            ...
            campaignGameStarter.AddGameMenuOption("town_manage_slavery", "profit_allocation",
                ...
                List<InquiryElement> elements = new List<InquiryElement>()
                    {
                        new(DestinationTypes.Clan, _destinationNames[DestinationTypes.Clan].ToString(), null),
                        new(DestinationTypes.TownProsperity, _destinationNames[DestinationTypes.TownProsperity].ToString(), null),
                        new(DestinationTypes.Construction, _destinationNames[DestinationTypes.Construction].ToString(), null)
                    };
                ...
                description.SetTextVariable("PROFIT",
                    ...
                    MBInformationManager.ShowMultiSelectionInquiry(new MultiSelectionInquiryData(
                        ...
                        description.ToString(), elements, true, 1, 1,
