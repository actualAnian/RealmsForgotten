...
namespace RealmsForgotten.AiMade
{
    public class UndeadHordeBehavior : CampaignBehaviorBase
    {
        ...
        private MobileParty CreateBanditParty(Settlement settlement)
        {
            ...
            MobileParty banditParty = BanditPartyComponent.CreateBanditParty(banditClan.StringId, banditClan, settlement.Hideout, true, null, settlement.Position);
            if (banditParty == null)
            {
        ...
        private void EngageNearbyEnemies(MobileParty banditParty)
        {
            ...
            if (nearbyEnemyParties.Count > 0)
            {
                ...
                banditParty.SetMoveEngageParty(target, MobileParty.NavigationType.All);
            }
        }
