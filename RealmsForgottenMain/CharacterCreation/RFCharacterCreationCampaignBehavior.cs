...
namespace RealmsForgotten.CharacterCreation
{
    public class RFCharacterCreationCampaignBehavior : CampaignBehaviorBase, ICharacterCreationContentHandler
    {
        ...
        public void AddCultureLocationMenu(CharacterCreationManager characterCreationManager)
        {
            ...
            List<StartType> typesForFiefStart = new() { StartType.King, StartType.Knight };
        ...
        private void AddRFSpecialStartMenu(CharacterCreationManager characterCreationManager)
        {
            ...
            narrativeMenu.AddNarrativeMenuOption(new("rf_menu_usurper", new TextObject("{=RFStartCleric1}A cleric of {CULTURE}", null), new TextObject("{=RFStartCleric2}Devoted to the faith, you set out with a retinue of the faithful to spread your creed across Aeurth.", null), new GetNarrativeMenuOptionArgsDelegate(RFStartMenuUsurperNarrativeOptionArgs), new NarrativeMenuOptionOnConditionDelegate(m => { return true; }), new NarrativeMenuOptionOnSelectDelegate(m => { ChooseCharacterEquipment(m, StartType.Usurper); }), new NarrativeMenuOptionOnConsequenceDelegate(UsurperStartOnConsequence)));
