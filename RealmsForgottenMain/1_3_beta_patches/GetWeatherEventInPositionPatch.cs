...
namespace RealmsForgotten
{
    ...
    //    [HarmonyPatch(typeof(DefaultMapWeatherModel), nameof(DefaultMapWeatherModel.WeatherUpdateFrequency), MethodType.Getter)]
    //    public static bool Prefix(ref CampaignTime __result)
    //    {
    //        long a = 140625;
    //        var ctor = AccessTools.Constructor(typeof(CampaignTime), new Type[] { typeof(long) });
    //        __result = (CampaignTime)ctor.Invoke(new object[] { a });
    //        return false;
    //    }
    //}
}
