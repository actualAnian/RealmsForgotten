...
namespace RealmsForgotten.CampaignCheats
{
    ...
    {
        readonly static List<Occupation> _villageNotableOccupations = new() { Occupation.Artisan, Occupation.Merchant, Occupation.GangLeader };
        readonly static List<Occupation> _townNotableOccupations = new() { Occupation.Headman, Occupation.RuralNotable };
