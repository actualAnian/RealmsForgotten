...
namespace RF_AIDialog
{
    ...
    public class AIDialogQuest : QuestBase
    {
        ...
        // Must be true so QuestManager.OnGameLoaded treats this as a standalone
        // (non-issue) quest and calls InitializeQuestOnLoadWithQuestManager()
        // instead of cancelling it with a FailedAssert crash.
