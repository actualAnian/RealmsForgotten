    ...
    public class ArmorCraftingVM : ViewModel
    {
        ...
        public ArmorCraftingVM(CraftingMixin mixin, CraftingVM craftingVm, Crafting crafting)
        {
            ...
            foreach (ItemType value in Enum.GetValues(typeof(ItemType)))
            {
                ...
                armorClasses.Add(GameTexts.FindText("str_rfsmithing_crafting_itemtype", value.ToString().ToLower()));
            }
        ...
        private void RefreshArmorDesignMode(int classIndex)
        {
            ...
            CurrentCraftedArmorTypeText = GameTexts.FindText("str_rfsmithing_crafting_itemtype", _selectedItemType.ToString().ToLower()).ToString();
        ...
        public override void RefreshValues()
        {
            ...
            if (baseSmithingModel is RFSmithingModel smithingModel)
        ...
        public void RefreshStats(ItemType itemType)
        {
            ...
            switch (itemType)
            {
                ...
                case ItemType.ArmArmor:
                case ItemType.LegArmor:
                    TextObject headDescriptionText = GameTexts.FindText("str_rfsmithing_crafting_statdisplay", ItemType.HeadArmor.ToString().ToLower());
                    TextObject bodyDescriptionText = GameTexts.FindText("str_rfsmithing_crafting_statdisplay", ItemType.BodyArmor.ToString().ToLower());
                    TextObject legDescriptionText = GameTexts.FindText("str_rfsmithing_crafting_statdisplay", ItemType.LegArmor.ToString().ToLower());
                    TextObject armDescriptionText = GameTexts.FindText("str_rfsmithing_crafting_statdisplay", ItemType.ArmArmor.ToString().ToLower());
                ...
                case ItemType.Barding:
                    TextObject horseDescriptionText = GameTexts.FindText("str_rfsmithing_crafting_statdisplay", ItemType.Barding.ToString().ToLower());
                ...
                case ItemType.Shield:
                    TextObject shieldSpeedDescriptionText = GameTexts.FindText("str_rfsmithing_crafting_statdisplay", "speed");
                    TextObject shieldHitPointsDescriptionText = GameTexts.FindText("str_rfsmithing_crafting_statdisplay", "shield_hitpoints");
                ...
                case ItemType.Bow:
                case ItemType.Crossbow:
                    TextObject rangedWeaponSpeedDescriptionText = GameTexts.FindText("str_rfsmithing_crafting_statdisplay", "ranged_weapon_speed");
                    ...
                    if (itemType == ItemType.Crossbow)
                    {
                        TextObject ammoLimitDescriptionText = GameTexts.FindText("str_rfsmithing_crafting_statdisplay", "ammo_limit");
