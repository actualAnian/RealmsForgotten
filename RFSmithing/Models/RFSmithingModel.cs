...
{
    public class RFSmithingModel : SmithingModel
    {
        private readonly SmithingModel _model;

        public RFSmithingModel(SmithingModel model)
        {
            _model = model;
        }
        ...
        {
            ItemObject baseResult = _model.GetCraftingMaterialItem(craftingMaterial);
            return baseResult;
        }
