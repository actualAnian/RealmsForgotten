...
namespace RealmsForgotten.AiMade.Religions
{
    public class PriestCampaignBehavior : CampaignBehaviorBase
    {
        ...
        {
            // CampaignBehaviorBase instances are not saveable data — syncing the
            // quest-behavior references here would silently fail on save and come
            // back null on load. Both references are wired through the constructor
            // at registration time, so there is nothing to persist.
        }
